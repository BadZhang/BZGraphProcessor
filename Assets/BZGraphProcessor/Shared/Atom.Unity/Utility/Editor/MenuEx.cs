...
#if HALOMAN
        [MenuItem("Tools/BZGraphProcessor.Shared/Path Print/DataPath")]
#endif
...
#if HALOMAN
        [MenuItem("Tools/BZGraphProcessor.Shared/Path Print/StreamingAssetsPath")]
#endif
...
#if HALOMAN
        [MenuItem("Tools/BZGraphProcessor.Shared/Path Print/PersistentDataPath")]
#endif
...
#if HALOMAN
        [MenuItem("Tools/BZGraphProcessor.Shared/Path Print/TemporaryCachePath")]
#endif
...
#if HALOMAN
        [MenuItem("Tools/BZGraphProcessor.Shared/Path Print/ComsoleLogPath")]
#endif
