...
namespace BZGraphProcessor.Editor
{
    ...
    public abstract class BaseGraphWindow : BaseEditorWindow
    {
        ...
        {
            Load(ViewModelFactory.ProduceViewModel(BZGraphProcessor.Editor.GraphProcessorEditorUtil.Clone(graphAsset.LoadGraph())) as BaseGraphProcessor, null, graphAsset);
        }
        ...
        {
            GraphAsset?.SaveGraph(BZGraphProcessor.Editor.GraphProcessorEditorUtil.Clone(GraphProcessor.Model));
            if (UnityGraphAsset)
