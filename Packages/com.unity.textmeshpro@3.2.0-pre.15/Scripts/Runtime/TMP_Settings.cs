...
namespace TMPro
{
    ...
    public class TMP_Settings : ScriptableObject
    {
        ...
        public static TMP_Settings instance
        {
            get
            {
                if (s_Instance == null)
                {
                    ...
                    #if UNITY_EDITOR
					s_Instance = UnityEditor.AssetDatabase.LoadAssetAtPath<TMP_Settings>("Assets/GameData/Font/TMP_Settings.asset");
                    
                    // Make sure TextMesh Pro UPM packages resources have been added to the user project
                    if (!s_Instance && Time.frameCount != 0 || (!s_Instance && s_Instance.assetVersion != s_CurrentAssetVersion))
                    {
                    ...
                    if (!s_Instance && s_Instance.m_ActiveFontFeatures.Count == 1 && s_Instance.m_ActiveFontFeatures[0] == 0)
                    {
        ...
        {
            get { return TMP_Settings.instance == null; }
        }
